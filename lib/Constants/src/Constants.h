...
const uint32_t ENGINE_RPM_FILTER_M = 3;
const uint32_t ENGINE_RPM_FILTER_N = 3;
...
const uint32_t SECONDARY_RPM_FILTER_M = 3;
const uint32_t SECONDARY_RPM_FILTER_N = 3;
